        ...
        <div v-else-if="product" class="bg-white shadow-lg rounded-xl overflow-hidden">
            ...
            <div class="flex flex-col md:flex-row">
                ...
                <div class="md:w-1/2 relative">
                    <div class="h-[500px] overflow-hidden bg-gray-100">
                    ...
                    <div class="absolute top-3 right-3">
                        <span v-if="product.stock > 5"
                            class="bg-green-500 text-white px-3 py-1 rounded-full font-medium">
                            {{ t('producto.inStock') }}
                        </span>
                ...
                <div class="md:w-1/2 p-6 md:p-8 md:overflow-y-auto">
                    <div class="flex flex-col mb-6">
                        <h1 class="text-3xl font-bold text-gray-800 mb-3">{{ product.titulo }}</h1>
                        ...
                        <div class="mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div class="bg-blue-50 p-4 rounded-lg shadow-sm border border-blue-100">
                                    ...
                                    <p class="text-gray-900 font-semibold">{{ t(`producto.estados.${product.estado}`) }}
                                    </p>
                                </div>
                                ...
                                <!-- Fechas -->
                                <div class="bg-blue-50 p-4 rounded-lg shadow-sm border border-blue-100 col-span-full"
                                    v-if="isAdmin">
                        ...
                        <div v-if="product.camposCategoria && product.camposCategoria.length > 0">
                            <h2 class="text-xl font-semibold mb-6 text-gray-800 flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 text-blue-500" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div v-for="(campo, index) in product.camposCategoria" :key="index"
                                    ...
                                    <p class="text-gray-900 font-semibold">{{ campo.datos || t('common.notAvailable') }}
                                    </p>
                                </div>
                            </div>
                        </div>
